/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3e96f2d663a2d6fd03d8577a55ac9a73)
...
interface __BaseEnv_Env {
	...
	PUBLIC_URL: "https://letterboxd-mcp.<account>.workers.dev";
	TIMEZONE: "America/Vancouver";
	READ_ONLY: "false";
	ALLOWED_REDIRECT_HOSTS: "claude.ai,claude.com,chatgpt.com";
	ENVIRONMENT: "production";
	LB_TOKENS: DurableObjectNamespace<import("./src/index").LetterboxdTokenStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LetterboxdTokenStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_URL" | "TIMEZONE" | "READ_ONLY" | "ALLOWED_REDIRECT_HOSTS" | "ENVIRONMENT">> {}
}
